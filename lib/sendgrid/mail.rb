...
module SendGrid
  class Mail
    ...
    def add_attachment(path, name = nil)
      mime_type = {}
      mime = MIME::Types.type_for(File.extname(path).to_s.downcase)
      mime_type = { "@mediatype": mime[0].media_type, "@subtype": mime[0].sub_type, "@type": mime[0].content_type }.to_hash if mime.present?
